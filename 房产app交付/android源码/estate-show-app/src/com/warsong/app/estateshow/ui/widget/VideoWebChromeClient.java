 ...
 * 
 */
public class VideoWebChromeClient extends WebChromeClient implements OnPreparedListener,
	 ...
	 */
	public VideoWebChromeClient(View activityNonVideoView, ViewGroup activityVideoView,
			View loadingView, VideoWebView webView) {
		this.activityNonVideoView = activityNonVideoView;
		this.activityVideoView = activityVideoView;
		this.loadingView = loadingView;
		...
		if (view instanceof FrameLayout) {
			...
			if (focusedChild instanceof android.widget.VideoView) {
				...
				if (webView != null && webView.getSettings().getJavaScriptEnabled()) {
					// Run javascript code that detects the video end and other
					// events that should cause low profile UI, and notifies the
					// interface
					...
					js += "if (_ytrp_html5_video != undefined && _ytrp_html5_video != _ytrp_html5_video_last) {";
					{
						...
						js += "function _ytrp_html5_video_low_profile() {";
						{
							js += "_VideoEnabledWebView.notifyVideoLowProfile();"; // Must
																					// match
																					// Javascript
																					// interface
																					// name
						...
						js += "_ytrp_html5_video.addEventListener('play', _ytrp_html5_video_low_profile);";
						js += "_ytrp_html5_video.addEventListener('durationchange', _ytrp_html5_video_low_profile);"; // For
																														// the
																														// first
																														// play
					}
	...
	@Override
	public void onShowCustomView(View view, int requestedOrientation, CustomViewCallback callback) // Available
																									// in
																									// API
																									// level
																									// 14+,
	...
	public void onHideCustomView() {
		...
		// it's not always called automatically.
